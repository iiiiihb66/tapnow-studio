...
自原作者 zhengxinlan1995-code 的 2.6.1 版本以来到 3.8.8 版本（截至 2026-04-09）持续进行高频迭代与修复，包含多次里程碑版本与重构，目前已进化为功能较为完善的工作流设计生产平台。
...
### 🚀 最新稳定版 (Latest Sync)
*   **版本号**: **v3.8.8** (2026-04-09)
*   **主要更新**: 
    *    **集成 Yjs 实时协作引擎**：支持节点、连接和光标的实时同步，实现多人协同办公。
    *    **版本迭代 3.8.8**：收拢 rc1-rc8 的 Yjs 相关功能。

### ✅ 最近版本（详细功能）
*   **v3.8.8 (2026-04-09)**
    * **实时协作增强**：引入 Yjs 核心，支持跨端实时编辑与光标同步。
*   **v3.8.7 (2026-02-12)**
